...
export const PARTS: Part[] = [
  ...
  },
  {
    ...
    types: [
      ...
      { slug: 'multiple', title: '多重背包', blurb: '朴素·二进制·单调队列', status: 'ready' },
      { slug: 'group', title: '分组背包', blurb: '每组至多选一件', status: 'ready' },
      { slug: 'mixed', title: '混合背包', blurb: '01/完全/多重同题', status: 'ready' },
      { slug: 'cost2d', title: '二维费用背包', blurb: '两种费用同时受限', status: 'ready' },
      { slug: 'dep', title: '有依赖的背包', blurb: '主件-附件·依赖→分组', status: 'ready' },
      { slug: 'variant', title: '背包综合变形', blurb: '方案数·撤销·具体方案', status: 'ready' },
      { slug: 'fractional', title: '辨析：分数背包=贪心', blurb: '可分割⇒贪心 vs 整取⇒DP', status: 'ready' },
    ],
  },
  {
