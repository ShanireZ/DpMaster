    ...
    <>
      ...
      <section className="lesson">
        ...
        <InfoBox kind="warn" title="常见陷阱 · 严格上升 vs 不降">
          ...
          一字之差，结果就差一截——<Link to="/part/a/lcs" style={{ color: 'var(--accent-2)' }}>下一节 LCS</Link> 里 <strong>P1439 排列 LCS</strong> 正是靠把问题转成 LIS、再用这套二分做到 <M>{'O(n\\log n)'}</M> 的。
        </InfoBox>
      </section>
