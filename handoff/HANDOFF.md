...
> ★**权威标准**：`05-内容创作标准.md`——章节流水线、深度基线、文风、组件词汇表、自检清单，全部提炼自已验收的 01/完全背包两页。写每个新类型页前先读它。本节以下为速览。
...
- `03-设计与交互规范.md` — Warm Ink 设计系统/DP 引擎/游戏清单（★注：§1.2 的旧「七色拉开色轮」已被 `tokens.css` 的**暖矿·低饱和宝石**取代，以 `tokens.css` 为准）
- `04-技术栈与素材清单.md` — 选型/2026 许可证/免费素材/性能红线
- `05-内容创作标准.md` — ★**类型页撰写权威标准**（黄金样板=B 背包 01/完全）：章节流水线/深度基线/文风/组件词汇表/自检清单
